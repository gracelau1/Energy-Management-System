...
#Tech Stack, Systems Architecture and Client Gains
...
<li>Pipeline is repeated for <strong><span style="text-decoration:underline;">X</span></strong> number of days (as many as specified by client for a larger, more reflective dataset)</li>
...
EnergyScout Simulation Software calculates energy savings <strong>based on</strong> real<strong> people-flow data collected</strong> and<span style="text-decoration:underline;"> </span><strong>client’s choice of EMS parameters</strong>
<ul>
...
<li>Based on parameters chosen, outputs a <strong>projected energy savings report</strong> that<strong> <span style="text-decoration:underline;">factors in</span></strong>:</li> 
<ul>
...
<li>And balances it against energy savings to <strong><span style="text-decoration:underline;">calculate metrics key for decision making</span></strong>:</li>  
<ul>
